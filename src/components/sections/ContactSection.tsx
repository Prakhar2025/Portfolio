...
const socialLinks = [
    {
        name: 'GitHub',
        href: 'https://github.com/Prakhar2025',
        icon: (
    ...
    {
        name: 'LinkedIn',
        href: 'https://www.linkedin.com/in/prakhar-shukla-471649261',
        icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
        name: 'LeetCode',
        href: 'https://leetcode.com/u/PrakharShukla2005/',
        icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
        name: 'Twitter',
        href: 'https://x.com/prakhar_builds',
        icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
        name: 'Dev.to',
        href: 'https://dev.to/coldstartdev',
        icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
