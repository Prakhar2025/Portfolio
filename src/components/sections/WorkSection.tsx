...
const projects = [
    ...
    },
    {
        ...
        tech: ['Next.js 14', 'Go', 'Python', 'FastAPI', 'IBM Bob', 'tree-sitter', 'PostgreSQL', 'Docker'],
        live: 'https://p-rism-zeta.vercel.app/',
        github: 'https://github.com/Prakhar2025/PRism',
        article: 'https://github.com/Prakhar2025/PRism/blob/main/docs/ARCHITECTURE.md',
        articleLabel: 'Architecture Docs',
    },
    {
        id: 2,
                                ...
                                <div className="p-6 sm:p-8 flex flex-col h-full">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        {'article' in project && project.article && (
                                            ...
                                            >
                                                <span className="flex items-center gap-2">
                                                    {'articleLabel' in project && project.articleLabel ? (project.articleLabel as string) : 'Article'}
                                                    <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
